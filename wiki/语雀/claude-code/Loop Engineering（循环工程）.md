...
```
┌─────────────────────────────────────────────┐
│         第三层：External Feedback Loop        │
│           （外部反馈循环 / 天级别）              │
│  用户反馈 → 数据分析 → 竞品研究 → 修正产品方向    │
│  ┌───────────────────────────────────────┐   │
│  │      第二层：Developer Feedback Loop    │   │
│  │        （开发者反馈循环 / 小时级别）       │   │
│  │  审查产品 → 修订 Spec → 补充 Eval        │   │
│  │  ┌──────────────────────────────┐    │   │
│  │  │  第一层：Agentic Coding Loop  │    │   │
│  │  │   （智能体编码循环 / 分钟级别）  │    │   │
│  │  │  写代码→测试→发现Bug→修复→再测 │    │   │
│  │  └──────────────────────────────┘    │   │
│  └───────────────────────────────────────┘   │
...
> 详细对比参见 [[Harness Engineering（驾驭工程）]]
...
**类比：**
- **[[Harness Engineering（驾驭工程）]] = 给赛马装好缰绳、马鞍、嚼子**（确保它不会失控）
...
- [[Harness Engineering（驾驭工程）]] — Loop Engineering 的互补概念，负责 Agent 的安全护栏
- [[Claude Code学习笔记]] — Claude Code 核心机制，Loop Engineering 的主要实践平台
